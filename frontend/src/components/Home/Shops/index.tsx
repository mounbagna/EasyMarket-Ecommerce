...
import "swiper/css";
import ShopOwnersList from "./shopownerslist";
...
const ShopOwners = () => {
  ...
  const shopOwnerCards: ShopOwnerCard[] = shopowners.map((owner) => ({
    id: owner.id,
    shop_name: `${owner.shop_name}`,
    address:owner.address,
    image: owner.image?.[0] || "/images/404.svg",
    ...
    <section className="overflow-hidden pt-17.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        <div className="swiper categories-carousel common-carousel">
              ...
              <span className="flex items-center gap-2.5 font-medium text-dark mb-1.5">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0_834_7356)">
                    ...
                    <circle cx="7.17245" cy="7.39917" r="1.66667" transform="rotate(-45 7.17245 7.39917)" stroke="#3C50E0"
                      strokeWidth="1.5"/>
          ...
          >
            {shopOwnerCards.map((item, key) => (
              <SwiperSlide key={key}>
                <ShopOwnersList item={item} />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
