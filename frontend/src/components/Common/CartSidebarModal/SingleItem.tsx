...
const SingleItem = ({ item, removeItemFromCart }) => {
  ...
  const thumbnail = item.thumbnail || "[]";
    //const thumbnail = typeof item.thumbnail === "string" ? JSON.parse(item.thumbnail) : item.thumbnail || "[]";
    ...
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-6">
        <div className="flex items-center justify-center rounded-[10px] bg-gray-3 max-w-[90px] w-full h-22.5">
          <img src={getImageUrl(item.thumbnail?.[0])} alt="product" width={100} height={100} />
        </div>
        ...
        <div>
          ...
          <p className="text-custom-sm">Price: {item.discounted_price} FCFA</p>
        </div>
      </div>
