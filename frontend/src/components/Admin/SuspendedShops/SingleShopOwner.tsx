...
const SingleShopOwner = () => {
   const [shops,setShops] = useState<any>([]);
    ...
    const loadShops =()=>{
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/suspended-shops`,{
            headers:{
    ...
    const reactivateShop = async(id:number)=>{
      await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/reactivate-shop/${id}`,{method:"PUT"});
      loadShops();  
    };
