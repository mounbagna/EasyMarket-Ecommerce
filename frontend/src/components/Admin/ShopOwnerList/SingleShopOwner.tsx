...
const SingleShopOwner = () => {
   const [shops,setShops] = useState<any>([]);
    ...
    const loadShops =()=>{
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/shopowners`,{
            headers:{
    ...
    const deleteShop = async(id:number)=>{
     const confirmDelete = confirm("Delete this shop permanently ?");
     if(!confirmDelete) return;
     await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/${id}`,{method:"DELETE"});
      loadShops();  
    };
