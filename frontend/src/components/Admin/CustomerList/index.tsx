"use client";
import SingleShopOwner from "./SingleCustomer";
        ...
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mt-10">
              <h2 className="font-medium text-dark text-2xl mb-8">Active Shops</h2>
            </div>
              ...
              <div className="w-full overflow-x-auto">
                <div className="min-w-[1170px]">
                  <div className="flex items-center py-5.5 px-7.5">
                    ...
                    <div className="min-w-[200px]">
                      <p className="text-dark">Monthly payment Deadline</p>
                    </div>

                    <div className="min-w-[200px]">
                      <p className="text-dark">Date of Creation</p>
                    </div>
